...
[base_location_geonames_import](base_location_geonames_import/) | 10.0.1.0.1 | :repeat: | Import better zip entries from Geonames
...
[partner_contact_job_position](partner_contact_job_position/) | 10.0.1.0.0 | :repeat: | Categorize job positions for contacts
...
[partner_create_by_vat](partner_create_by_vat/) | 10.0.1.0.0 | :repeat: | Using VIES webservice, name and address information will be fetched and added to the partner.
